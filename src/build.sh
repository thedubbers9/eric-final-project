...
yosys -p "read_verilog -sv alu.sv branch_jump.sv chip.sv control.sv cpu_on_fpga.sv decode.sv ec_pipe_reg.sv execute.sv fe_pipe_reg.sv fetch.sv flags_register.sv memory.sv register_file.sv; synth_ecp5 -json build/synthesis.json -top cpu_on_fpga -noflatten"
